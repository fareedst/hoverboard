...
| 7c | [page-archives.md](page-archives.md) | archive artifact, archive-bookmark association, archive-capable backend, archive privacy boundary, archived-content scope, archive snippet, compensation outcome, Offline Reader, Reader target, screenshot artifact, selected-backend lookup, CAPTURE_PAGE_ARCHIVE, SEARCH_ARCHIVED_CONTENT, CAPTURE_PAGE_SCREENSHOT |
