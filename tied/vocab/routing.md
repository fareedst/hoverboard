...
|-----|------|------------------------|
| 1 | [tied-methodology.md](tied-methodology.md) | TIED layout, semantic tokens, module validation, binding inventory, composition evidence, bootstrap, methodology migration, client refresh, canonical-source anchor, local project coverage, `merge-vocab`, methodology vs project YAML, PROC-* process names, `copy_files.sh`, detail files, `yaml_tool`, `yaml_list_sorter`, sort map keys, `yaml_semantic_compare`, `compare_yaml_dirs` |
...
| 5 | [pseudocode-and-citdp.md](pseudocode-and-citdp.md) | Domain vocab vs IMPL grammar, contract precision, binding inventory, composition evidence, three-way alignment, full-block duplication, canonical-source anchor, UPPER_SNAKE blocks, CITDP record naming, essence_pseudocode, sub-vocabulary-sync |
...
| 5b | [test-composition.md](test-composition.md) | composition test, composition pattern, binding, composition edge, edge status, unit-first RED, testability ladder, MESSAGE_DISPATCH, UI_EMIT_COMMAND, ORCHESTRATOR_STATUS, ROUTER_STORAGE, LAZY_INIT_GUARD, EVENT_REFRESH_GUARD, ORDERED_ASYNC_HANDOFF, NATIVE_ADAPTER_CALLBACK, SCOPED_DOM_BINDING, composition:plan, generated composition test, Phase G, composed_with, test seam, entry-point wiring, IPC binding |
| 6 | [storage-backends.md](storage-backends.md) | storage backend, pinboard/local/file/sync/browser, Browser storage (backend), 2C, collapseByUrl, ENSURE_TAG_FOLDERS, stripChromeRootSegments, storage index, BookmarkRouter, preferredBackend, Save to, effective backend, metadata-capable backend, Read Later metadata fallback, moveBookmarkToStorage, native host, hoverboard-bookmarks.json, `~/.hoverboard`, Local Query API, aggregate-snapshot, api-token, hoverboard-local-api |
| 7 | [bookmarks.md](bookmarks.md) | pin, bookmark, description/extended/shared/toread, Read Later, new Read Later save, persisted bookmark, Private, badge display, BOOKMARK_UPDATED, usage tracking, Pinboard API, Title/Notes Details UI |
| 7b | [bookmarks-index.md](bookmarks-index.md) | Local Bookmarks Index, Stores L/F/S/B, Browser (B), live Browser source, source=browser, export scope, Skip/Overwrite/Merge, target-scoped conflict lookup, collapsed footer, activeFooterGroup, Browser Bookmark Import, Netscape Bookmark File Format, regex replace, Search Bookmarks, link health, Health column, Refresh API snapshot |
| 7c | [page-archives.md](page-archives.md) | archive artifact, backend-scoped archive identity, archive-bookmark association, archive-capable backend, archive privacy boundary, archived-content scope, archive snippet, compensation outcome, Offline Reader, Reader target, Reader error state, screenshot artifact, selected-backend lookup, ARCHIVE_ENTRY_KEY, RENDER_READER_ERROR, CAPTURE_PAGE_ARCHIVE, SEARCH_ARCHIVED_CONTENT, CAPTURE_PAGE_SCREENSHOT |
...
| 9 | [side-panel.md](side-panel.md) | side panel, This Page, By Tag, Tabs, Browser Bookmarks page, standalone page, absence check, Visit History page, Usage panel (legacy), web protocol, tools toolbar, tool page shell, tool-page-version, non-web dismisses side panel, recently closed, tab search scopes, gather/distribute, to-read/private indicator, post-batch bookmark refresh, window-focus Recent Tags refresh, tabChangeRefresh, tab-change This Page refresh, non-scriptable URL |
| 10 | [ui-surfaces.md](ui-surfaces.md) | overlay, Show Hover, popup, theme, badge, quick access, icon click, tools toolbar, tool page shell, PopupController, UIManager, readLater event, informational action feedback, showInfo, OVERLAY_ACTION_IDS, POPUP_ACTION_IDS, injectionOutcome, non-scriptable URL |
