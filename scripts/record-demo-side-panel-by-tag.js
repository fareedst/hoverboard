...
async function main () {
  ...
  // Step 5: Tree updated — state; [IMPL-DEMO_OVERLAY] highlight tree container for "Bookmarks under selected tags"
  await clearHighlight()
  ...
  // Step 7: Click URL (if any) — result; [IMPL-DEMO_OVERLAY] highlight first link for "Opens in new tab"
  ...
  if (await firstLink.isVisible()) {
    ...
    await page.waitForTimeout(400)
    await snap()
    // Extra beat at end of animation (Step 7)
    await page.waitForTimeout(400)
    await snap()
    await page.waitForTimeout(400)
    await snap()
