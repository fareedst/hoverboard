...
export class UIManager {
  ...
  setupEventListeners () {
    ...
    // [IMPL-MOVE_BOOKMARK_UI] [ARCH-MOVE_BOOKMARK_UI] [REQ-MOVE_BOOKMARK_STORAGE_UI] [REQ-STORAGE_MODE_DEFAULT] [REQ-READ_LATER_BROWSER_FALLBACK] READ_LATER_EVENT_BINDING: shared popup and This Page event reaches PopupController.handleReadLater.
